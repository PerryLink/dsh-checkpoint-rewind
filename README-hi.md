...
कॉपी प्रदाता कार्यक्षेत्र को **`.gitignore` का सम्मान करते हुए** स्कैन करता है (रूट और नेस्टेड फ़ाइलें, गहरे नियम और `!` री-इन्क्लूड प्राथमिकता पाते हैं) `excludeGlobs` के अतिरिक्त, जिससे जानबूझकर विशाल अनदेखी निर्देशिकाएँ (डेक कैशे, बिल्ड आउटपुट) की कोई लागत नहीं होती। हर वॉक `maxSnapshotFiles` / `snapshotTimeoutMs` बजट से भी सीमित है: जो कार्यक्षेत्र इन बजटों को पार करता है वह उस स्नैपशॉट को एक जोरदार चेतावनी के साथ छोड़ देता है — गार्डेड टूल कॉल हमेशा आगे बढ़ती है, और `agent.cancel` (या रद्द/बाधित टर्न) चालू वॉक को रद्द कर देता है।
...
| `respectGitignore` | `true` | कॉपी प्रदाता कार्यक्षेत्र के `.gitignore` का सम्मान करता है (रूट + नेस्टेड, गहरे नियम और `!` री-इन्क्लूड प्राथमिकता पाते हैं) — अनदेखी कैश/आर्टिफैक्ट ट्री कभी स्कैन नहीं होते |
| `maxSnapshotFiles` | `100000` | प्रति-स्नैपशॉट वॉक बजट फ़ाइलों में; इसे पार करने पर टूल कॉल को अटकाने के बजाय स्नैपशॉट को जोरदार चेतावनी के साथ छोड़ दिया जाता है |
