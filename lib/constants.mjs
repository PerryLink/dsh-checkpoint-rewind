...
export const DEFAULTS = Object.freeze({
  ...
  // copy provider 读取工作区 .gitignore（根+嵌套，深层覆盖含 ! 取反）。
  // 巨型被忽略目录（缓存/产物）若无视 ignore 规则会被整树快照（真实事故）。
  RESPECT_GITIGNORE: true,
  // 快照遍历预算护栏：超限即跳过快照并响亮告警（快照是安全网，绝不能
  // 比被保护的操作更贵）。files 是遍历到的文件计数（不含被排除项）。
  MAX_SNAPSHOT_FILES: 100_000,
  SNAPSHOT_TIMEOUT_MS: 180_000,
...
export const LIMITS = Object.freeze({
  ...
  MIN_MAX_SNAPSHOT_FILES: 100,
  MIN_SNAPSHOT_TIMEOUT_MS: 1000,
  MAX_NOTE_LENGTH: 500,
  MAX_DIFF_FILES: 50,
})
