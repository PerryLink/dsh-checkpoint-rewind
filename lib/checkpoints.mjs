 ...
 * @returns {{kind: 'list'} | {kind: 'latest'} | {kind: 'step', step: number} | {kind: 'clear'} | {kind: 'id', input: string} | {kind: 'invalid', message: string}} 解析结果。
 */
export function parseRewindInput(rawInput) {
  ...
  if (step !== null) return { kind: 'step', step: Number(step[1]) }
