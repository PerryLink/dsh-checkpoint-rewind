 ...
 * @param {string | (() => string)} gitBin - Config.gitBin。
...
export class GitSnapshotProvider {
  ...
  /**
   * @param {{gitBin: string | (() => string), run?: (args: string[], opts?: {cwd?: string}) => Promise<{code: number, stdout: string, stderr: string}>}} deps - run 供测试注入 scripted git。
   */
  constructor(deps) {
...
/**
 * 构造 git provider。
 * @param {{gitBin: string | (() => string), run?: (args: string[], opts?: {cwd?: string}) => Promise<{code: number, stdout: string, stderr: string}>}} deps - 构造依赖。
