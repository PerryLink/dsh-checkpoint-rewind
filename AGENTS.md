...
.github/workflows/publish.yml   tag v* → 测试 + npm publish（**npm trusted publishing / OIDC，无 secret**）
...
```sh
npm install          # 安装 peer 依赖（@deepseek-ai/dsh-* 钉 0.1.7-alpha.2、cordis ^4.0.4、schemastery ^3.18.4、zod 等）
