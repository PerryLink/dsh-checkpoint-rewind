...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.3-alpha.1` (GitHub टैग, 2026-09-06 को सत्यापित; npm पिन `0.1.2-rc.1`, peers `>=0.1.2-rc.1 <0.2.0`) (2026-09-02 को अनुकूलित): सत्र लिफ़ाफ़ा अपना ignorable फ़ील्ड केवल संग्रहीत-लॉग पठन संगतता के लिए रखता है - Session.append अभी भी इसे स्टैम्प नहीं कर सकता, इसलिए गेट व्यवहार अपरिवर्तित है। 2026-09-06 को dsh-v0.1.3-alpha.1 master चेकआउट के विरुद्ध सत्यापित (पूर्ण गेट श्रृंखला + प्रोफ़ाइल इंस्टॉल स्मोक)। |
| Node | `^22.19.0 \|\| >=24.0.0` |
