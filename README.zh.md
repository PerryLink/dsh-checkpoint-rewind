...
| 方面 | 状态 |
|---|---|
| Harness | DeepSeek Harness `0.1.1-rc.2`（peer 依赖范围 `>=0.1.0-rc.8 <0.2.0`） 0.1.2-alpha.5（2026-09-02 已适配）：会话信封保留 ignorable 字段但仅用于存量日志读取兼容——Session.append 仍无法盖章，门控行为不变。 |
| Node | `^22.19.0 \|\| >=24.0.0` |
